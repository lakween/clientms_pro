...
<html>
<head>
	<title>Client Management Sysytem || View Client </title>
...
<!-- add claim bonus page-->
<p align="center">                            
 <button class="btn btn-primary waves-effect waves-light w-lg" data-toggle="modal" data-target="#myModal">Add New Claim </button></p> 
