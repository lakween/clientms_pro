			...
			<div class="inner-content">
				...
				<div class="outter-wp">
					...
					<div class="graph-visual tables-main">
						...
						<h3 class="inner-tittle two">Search Services </h3>
						<div class="graph">
...
$sql2="select distinct tblclient.FullName,tblclient.Department,tblsalaryinvoice.BillingId,tblsalaryinvoice.PostingDate from  tblclient   
	join tblsalaryinvoice on tblclient.ID=tblsalaryinvoice.Userid  where tblsalaryinvoice.BillingId like '%$sdata%'";
