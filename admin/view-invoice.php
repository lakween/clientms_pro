...
<html>
<head>
	<title>Client Management Sysytem || View Report </title>
...
<body>
	<div class="page-container">
				...
				<div class="outter-wp">
					...
					<div class="sub-heard-part">
						<ol class="breadcrumb m-b-0">
							...
							<li class="active"> Service View Report</li>
						</ol>
					</div>
					<!--//sub-heard-part-->
		<div class="graph-visual tables-main" id="exampl">
						...
						<h3 class="inner-tittle two"> Service Report Details </h3>
<?php
$invid=intval($_GET['invoiceid']);
$sql="select distinct tblclient.FullName,tblclient.Department,tblclient.ContactNumber,tblclient.Email,tblclient.AccountID,tblinvoice.BillingId,tblinvoice.PostingDate from  tblclient   
