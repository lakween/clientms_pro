...
{               ?>
	<div class="form-group"> <label for="exampleInputEmail1">Insurance Type </label> <input type="text" name="sname" value="<?php echo $row->ServiceType;?>" class="form-control" required='true' readonly='true'> </div>
