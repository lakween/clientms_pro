...
<html>
<head>
	<title>Bingo Insurance Sysytem || View Location Logs </title>
...
<body>
	<div class="page-container">
				...
				<div class="outter-wp">
					...
					<div class="sub-heard-part">
						<ol class="breadcrumb m-b-0">
							...
							<li class="active">View Location Logs</li>
						</ol>
					</div>
					<!--//sub-heard-part-->
		<div class="graph-visual tables-main" id="exampl">
						...
						<h3 class="inner-tittle two">View Location Logs</h3>
<?php
...
<th>Last Location</th>
<th>Distance Travel in KM Monthly</th>
...
<?php $cnt=$cnt+1;}
$gtotal=$subtotal1+$subtotal2+$subtotal3+$subtotal4;
} ?>

<tr>
<th colspan="4" style="text-align:center">Total Salary</th>
<th><?php echo "KM: ".$gtotal?></th>	
