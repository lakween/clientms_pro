...
<html>
<head>
	<title>Client Management Sysytem || Manage Insurance Services </title>
				...
				<div class="outter-wp">
					...
					<div class="sub-heard-part">
						<ol class="breadcrumb m-b-0">
							...
							<li class="active">Manage Insurance Services</li>
						</ol>
					</div>
					<!--//sub-heard-part-->
					<div class="graph-visual tables-main">
						...
						<h3 class="inner-tittle two">Manage Insurance Services</h3>
						<div class="graph">
							<div class="tables">
