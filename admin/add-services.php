...
$sql="insert into tblservices(ServiceType,ServiceName,ServicePrice)values(:stype,:sname,:price)";
...
$query->bindParam(':price',$price,PDO::PARAM_STR);
 $query->execute();
   ...
   if ($LastInsertId>0) {
    echo '<script>alert("New Client has been added.")</script>';
...
<div class="form-group"> <label for="exampleInputEmail1">Insurance Type :</label> 
		<select  name="stype"  required='true'>
