									     ...
									     <tr class="active">
									      <th scope="row"><?php echo htmlentities($cnt);?></th>
									       <td><?php  echo htmlentities($row->AccountID);?></td>
											...
											<td><a href="view-location-log.php?addid=<?php echo $row->ID;?>">View Location Log</a> ||
                                            <a href="location-details.php?addid=<?php echo $row->ID;?>">View Current Location</a></tr></td>
									     <?php $cnt=$cnt+1;}} ?>
									     </tbody> </table> 
							</div>
