...
{               ?>  
    ...
    <div class="menu">
        <ul id="menu" >
            ...
            <li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span> invoices</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                <ul id="menu-academico-sub" >
                    <li id="menu-academico-boletim" ><a href="invoices.php">Service Invoice</a></li>
                    <li id="menu-academico-boletim" ><a href="salary-invoices.php">Salary Invoice</a></li>
